...
<p class="has-text-align-center has-link-color has-background-color has-text-color has-medium-font-size">'. esc_html('Proudly Powered By WPRadiant','cv-portfolio-blocks') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->',
);