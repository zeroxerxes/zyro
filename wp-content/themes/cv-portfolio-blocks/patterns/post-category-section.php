...
<div id="about-section" class="wp-block-group"><!-- wp:columns {"verticalAlignment":"center"} -->
...
<h3 class="wp-block-heading has-poppins-font-family has-upper-heading-font-size" style="font-style:normal;font-weight:500;line-height:2.5">'. esc_html('Age - 25 Years','cv-portfolio-blocks') .'<br>'. esc_html('Email - support123@example.com','cv-portfolio-blocks') .'<br>'. esc_html('Freelancer - Available','cv-portfolio-blocks') .'</h3>
<!-- /wp:heading --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
