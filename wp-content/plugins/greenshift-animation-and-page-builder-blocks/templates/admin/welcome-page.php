...
<div class="wrap gspb_welcome_div_container">
    ...
    <nav class="nav-tab-wrapper">
        <div>
            <a href="<?php echo admin_url('admin.php?page=greenshift_dashboard');?>" class="nav-tab nav-tab-active">
                <?php esc_html_e("Getting Started", 'greenshift-animation-and-page-builder-blocks'); ?>
            </a>
            <a href="<?php echo admin_url('admin.php?page=greenshift');?>" class="nav-tab">
                <?php esc_html_e("Settings", 'greenshift-animation-and-page-builder-blocks'); ?>
            </a>
            <a href="<?php echo admin_url('admin.php?page=greenshift_dashboard-addons');?>" class="nav-tab">
                <?php esc_html_e("Addons", 'greenshift-animation-and-page-builder-blocks'); ?>
            </a>
            <a href="<?php echo admin_url('admin.php?page=greenshift_upgrade');?>" class="nav-tab">
                <?php esc_html_e("Upgrade", 'greenshift-animation-and-page-builder-blocks'); ?>
            </a>
            <a href="<?php echo admin_url('admin.php?page=greenshift_import');?>" class="nav-tab">
                <?php esc_html_e("Import/Export", 'greenshift-animation-and-page-builder-blocks'); ?>
            </a>
            <a href="<?php echo admin_url('admin.php?page=greenshift_contact');?>" class="nav-tab">
    ...
    <div class="gs-padd">
        <div class="gs_grid">
            <div class="greenshift_form gs_grid_1">
                <h1><?php esc_html_e("Getting Started with Greenshift", 'greenshift-animation-and-page-builder-blocks'); ?></h1>

                <p class="gs-introtext"><?php esc_html_e("Thank you for using Greenshift, full site page and animation builder with high performance and optimisation. Greenshift plugin is easy to use but we recommend to study materials on this page to get maximum functionality, better productivity and unique features.", 'greenshift-animation-and-page-builder-blocks'); ?></p>
                <div class="gs-intro-video"><iframe src="https://www.youtube.com/embed/3xbQcQ5LDEc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
            </div>
            <div class="gs_grid_2">
                <div class="greenshift_form">
                    <h3><?php esc_html_e("Recommended tutorials", 'greenshift-animation-and-page-builder-blocks'); ?></h3>

                    <div class="gs_main_text"><a href="https://youtu.be/Pvaqjz16QHk" target="_blank"><?php esc_html_e("Layout Options - start here", 'greenshift-animation-and-page-builder-blocks'); ?></a></div>
                    <div class="gs_main_text"><a href="https://www.youtube.com/watch?v=ijo7sBKGPIQ" target="_blank"><?php esc_html_e("In depth overview of unique options", 'greenshift-animation-and-page-builder-blocks'); ?></a></div>
                    <div class="gs_main_text"><a href="https://www.youtube.com/watch?v=pIz5U5eq2bQ" target="_blank"><?php esc_html_e("How to Use Presets", 'greenshift-animation-and-page-builder-blocks'); ?></a></div>
                    <div class="gs_main_text"><a href="https://youtube.com/playlist?list=PLIEKo1RENmYxbs3yL3nMuOzJJ0AY6GvQ2" target="_blank"><?php esc_html_e("Animation Addon overview", 'greenshift-animation-and-page-builder-blocks'); ?></a></div>
                    <div class="gs_main_text"><a href="https://www.youtube.com/playlist?list=PLIEKo1RENmYynw2olUEr8-wq7RDA3CQFQ" target="_blank"><?php esc_html_e("Overview of Dynamic fields", 'greenshift-animation-and-page-builder-blocks'); ?></a></div>
                </div>
                <div class="greenshift_form">
                    <h3><?php esc_html_e("Get support", 'greenshift-animation-and-page-builder-blocks'); ?></h3>
                    <p class="gs_intro_text"><?php esc_html_e("Do you need help. Check our official support channels and feel free to use them.", 'greenshift-animation-and-page-builder-blocks'); ?></p>
                    <div class="gs_main_text"><a href="?page=greenshift_contact">
                            <?php esc_html_e("Contact Us", 'greenshift-animation-and-page-builder-blocks'); ?>
                        </a></div>
                </div>
                <div class="greenshift_form">
                    <h3><?php esc_html_e("Our community", 'greenshift-animation-and-page-builder-blocks'); ?></h3>
                    <p class="gs_intro_text"><?php esc_html_e("Do you want to share some ideas, recommendations or simply want to introduce your site on our plugin or theme. Check our community channels", 'greenshift-animation-and-page-builder-blocks'); ?></p>
